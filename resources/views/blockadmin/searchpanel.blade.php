        ...
        <div class="flex-1 px-4 pb-4 space-y-4 overflow-y-hidden h hover:overflow-y-auto">
            ...
            <a href="#" class="flex space-x-4">
                <div class="flex-shrink-0">
                    <img class="w-10 h-10 rounded-lg" src="{{asset('assets/build/images/cover.jpg')}}" alt="Post cover" />
                </div>
            ...
            <a href="#" class="flex space-x-4">
                <div class="flex-shrink-0">
                    <img class="w-10 h-10 rounded-lg" src="{{asset('assets/build/images/avatar.jpg')}}" alt="Ahmed Kamel" />
                </div>
                <div class="flex-1 max-w-xs overflow-hidden">
            ...
            <a href="#" class="flex space-x-4">
                <div class="flex-shrink-0">
                    <img class="w-10 h-10 rounded-lg" src="{{asset('assets/build/images/cover-2.jpg')}}" alt="K-WD Dashboard" />
                </div>
                <div class="flex-1 max-w-xs overflow-hidden">
            ...
            <template x-for="i in 10" x-key="i">
                <a href="#" class="flex space-x-4">
                    <div class="flex-shrink-0">
                        <img class="w-10 h-10 rounded-lg" src="{{asset('assets/build/images/cover-3.jpg')}}" alt="K-WD Dashboard" />
                    </div>
                    <div class="flex-1 max-w-xs overflow-hidden">
                        <h4 class="text-sm font-semibold text-gray-600 dark:text-light">K-WD Dashboard</h4>
                        <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
